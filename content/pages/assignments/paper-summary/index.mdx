...
In this assignment, you will select a research paper related to NLP and/or DL and provide an easy-to-digest summary ([see the README in this repo for details on how to modify this site](https://github.com/uazhlt-ms-program/ling-582-course-blog#1-paper-summary)).
