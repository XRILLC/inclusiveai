...
In this assignment, you will select a research paper related to NLP and/or DL and provide an easy-to-digest summary ([see the README in this repo for details on how to modify this site](https://github.com/uazhlt-ms-program/ling-582-fall-2024-course-blog#1-paper-summary)).

As part of this assignment, you will select an open source/open weight LLM to assist with this task. One LLM model suggestion is [Llama 3.2 3B instruct variant](https://huggingface.co/meta-llama/Llama-3.2-3B-Instruct) and the [Jan UI](https://jan.ai/docs/tools/retrieval) (or [huggingchat](https://huggingface.co/chat/); see also [this post about tools for HuggingChat](https://huggingface.co/blog/community-tools)), or a multimodal VLM such as one of the [InternVL 2.0](https://internvl.github.io/blog/2024-07-02-InternVL-2.0/) variants.


<figure>
  <img src="https://public.parsertongue.com/courses/snlp-2/images/jan-example-nlp-paper-summary.png" alt="Jan UI" width="100%"/>
  <figcaption>Jan UI using a custom system prompt and <a href="https://huggingface.co/meta-llama/Llama-3.2-3B-Instruct">Llama 3.2 3B Instruct Q8</a>.  Try to experiment with different system prompts to help achieve the apprpriate level of detail (elicit supporting quotes, etc.).</figcaption>
</figure>
