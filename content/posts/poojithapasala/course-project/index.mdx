...
* **Week 2 (Nov 11 - Nov 17):**
    * Generate different poems using the FLANT5 model based on various prompts with different themes, emotions and contexts.
    * Test and debug initial poetry generation.
 
* **Week 3 (Nov 18 - Nov 24):**
    * Generate different poems using the LLAMA model based on various prompts with different themes, emotions and contexts.
